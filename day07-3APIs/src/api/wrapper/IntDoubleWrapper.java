...
public class IntDoubleWrapper {
	...
	public static void main(String[] agrs) {
		...
		//------------------------------------------------------------------------------------------
		// import static 하면 클래스명 생략 가능
		String intFrm2 = String.format("문자열[%s]를 기본형[%d]로 변경", intInput, parseInt(intInput));
		System.out.println(intFrm2); 
		
		String dblFrm2 = String.format("문자열[%s]를 기본형[%f]로 변경", dblInput, parseDouble(dblInput));
		System.out.println(dblFrm2); 
		...
		System.out.println(objTen);
		System.out.println(objSixty);
	}
}
